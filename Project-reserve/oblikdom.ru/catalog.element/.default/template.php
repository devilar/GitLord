						...
						<div class="catalog-detail-price" id="<?=$arItemIDs['PRICE'];?>">
											...
											<div class="available">
												<?if($arOffer["CAN_BUY"]) {?>
                                                   <?if($arParams['SHOW_MAX_QUANTITY'] !== 'N') {?>                                          
														...
														<div class="vs_dostavka">#VS_DOSTAVKA_DATA#</div>
                                                   <?}?>    
							...
							//DETAIL_PRICE//
								...
								<?} else {
									...
									<?}?>
									<span class="catalog-detail-item-price <?php if($arResult["MIN_PRICE"]["RATIO_PRICE"] < $arResult["MIN_PRICE"]["RATIO_BASE_PRICE"]) echo "red"; ?>">
										<span class="catalog-detail-item-price-current">
											<?if($arResult["COLLECTION"]["THIS"]) {?>
												<span class="from"><?=GetMessage("CATALOG_ELEMENT_FROM");?></span>
											<?}?>	
