<?php /* Smarty version Smarty-3.1.14, created on 2019-03-28 16:37:00
         compiled from "/home/c/cl36655/public_html/wa-apps/site/templates/actions/routing/RoutingEdit.html" */ ?>
<?php /*%%SmartyHeaderCode:20044713235c9ccdfc8b3f38-68394887%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '40069b9b1dbb6b6dab34e5b79c459cc107858472' => 
    array (
      0 => '/home/c/cl36655/public_html/wa-apps/site/templates/actions/routing/RoutingEdit.html',
      1 => 1545053313,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20044713235c9ccdfc8b3f38-68394887',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c9ccdfc991a44_07440538',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c9ccdfc991a44_07440538')) {function content_5c9ccdfc991a44_07440538($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include '/home/c/cl36655/public_html/wa-system/vendors/smarty3/plugins/function.html_options.php';
...
<br>
                    ...
                    <div class="field">
                        ...
                        <div class="value">
                            <label>
                                <input type="checkbox" value="1" id="ssl_all" name="params[ssl_all]" <?php if (!empty($_smarty_tpl->tpl_vars['route']->value['ssl_all'])){?> checked<?php }?> <?php if (empty($_smarty_tpl->tpl_vars['is_https']->value)){?>disabled<?php }?>> Перенаправлять на HTTPS<br>
                        ...
                        <div class="field">
                            ...
                            <div class="value">
                                <select name="params[static_content_type]">
                                    ...
                                    <option value="text/plain" <?php if (!empty($_smarty_tpl->tpl_vars['route']->value['static_content_type'])&&($_smarty_tpl->tpl_vars['route']->value['static_content_type']==='text/plain')){?> selected<?php }?>>text/plain</option>
                                    <option value="text/html" <?php if (!empty($_smarty_tpl->tpl_vars['route']->value['static_content_type'])&&($_smarty_tpl->tpl_vars['route']->value['static_content_type']==='text/html')){?> selected<?php }?>>text/html</option>
                                </select>
                            </div>
                        </div>
                        <div class="field">
