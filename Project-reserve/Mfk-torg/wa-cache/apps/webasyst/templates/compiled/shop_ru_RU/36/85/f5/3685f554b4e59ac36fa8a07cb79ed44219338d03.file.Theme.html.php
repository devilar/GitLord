<?php /* Smarty version Smarty-3.1.14, created on 2019-03-15 15:25:38
         compiled from "/home/c/cl36655/public_html/wa-system/design/templates/Theme.html" */ ?>
<?php /*%%SmartyHeaderCode:16506764895c8b99c2c2e409-70076304%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3685f554b4e59ac36fa8a07cb79ed44219338d03' => 
    array (
      0 => '/home/c/cl36655/public_html/wa-system/design/templates/Theme.html',
      1 => 1542820550,
      2 => 'file',
    ),
    '95a6549368fb4e2848bce4b0e1ca5959ab6fe631' => 
    array (
      0 => '/home/c/cl36655/public_html/wa-system/design/templates/ThemeDialogs.inc.html',
      1 => 1540900318,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16506764895c8b99c2c2e409-70076304',
  'function' => 
  array (
    '_renderThemeSetting' => 
    array (
  ...
  'unifunc' => 'content_5c8b99c2e63e36_02140676',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c8b99c2e63e36_02140676')) {function content_5c8b99c2e63e36_02140676($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_wa_datetime')) include '/home/c/cl36655/public_html/wa-system/vendors/smarty-plugins/modifier.wa_datetime.php';
...
">
<?php if (!is_callable('smarty_function_html_options')) include '/home/c/cl36655/public_html/wa-system/vendors/smarty3/plugins/function.html_options.php';
...
" data-search="<?php echo strip_tags($_smarty_tpl->tpl_vars['_setting']->value['name']);?>
"><div class="name"><span class="js-search-item-name"><?php echo $_smarty_tpl->tpl_vars['_setting']->value['name'];?>
</span><?php if (!empty($_smarty_tpl->tpl_vars['_setting']->value['tooltip'])){?><div class="wa-tooltip"><i class="icon10 info"></i><div class="wa-tooltip-content"><?php echo $_smarty_tpl->tpl_vars['_setting']->value['tooltip'];?>
...
</div><?php }?><?php }elseif($_smarty_tpl->tpl_vars['_setting']->value['control_type']=='checkbox'){?><input type="hidden" name="<?php if (!empty($_smarty_tpl->tpl_vars['_setting']->value['parent'])){?>parent_<?php }?>settings[<?php echo $_smarty_tpl->tpl_vars['_setting_var']->value;?>
]" value=""><input type="checkbox" name="<?php if (!empty($_smarty_tpl->tpl_vars['_setting']->value['parent'])){?>parent_<?php }?>settings[<?php echo $_smarty_tpl->tpl_vars['_setting_var']->value;?>
...
/<?php echo $_smarty_tpl->tpl_vars['_r']->value['url'];?>
 <i class="icon10 new-window"></i></a>
    ...
    <div class="wa-theme-content content right250px">
        ...
        <?php if ($_smarty_tpl->tpl_vars['theme_routes']->value&&!empty($_smarty_tpl->tpl_vars['settings']->value['items'])){?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('./ThemeDialogs.inc.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '16506764895c8b99c2c2e409-70076304');
content_5c8b99c2deec78_50444627($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /*  End of included template "./ThemeDialogs.inc.html" */?>

</div>

<?php $_smarty_tpl->tpl_vars['_locale'] = new Smarty_variable(array('will_be_lost'=>'Все изменения, которые вы вносили в этот файл, будут потеряны.','update_notice'=>mb_strtoupper('Все выбранные файлы будут перезаписаны оригинальными версиями из обновленной темы дизайна. В случае несовместимости изменений, которые вы вносили в тему дизайна, с шаблонами, CSS и другими ресурсами из новой версии темы внешний вид сайта может потребовать доработки вручную. Обновить тему?'),'expand_all'=>'Развернуть всё','collapse_all'=>'Свернуть всё','expand'=>'Свернуть','collapse'=>'Свернуть'), null, 0);?>
<script>
    (function ($) {
        new WAThemeSettings({
...
<div class="wa-design-scroll-action" id="wa-design-scroll-top">
    ...
    Наверх
</div><?php }} ?><?php /* Smarty version Smarty-3.1.14, created on 2019-03-15 15:25:38
         compiled from "/home/c/cl36655/public_html/wa-system/design/templates/ThemeDialogs.inc.html" */ ?>
<?php if ($_valid && !is_callable('content_5c8b99c2deec78_50444627')) {function content_5c8b99c2deec78_50444627($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/home/c/cl36655/public_html/wa-system/vendors/smarty3/plugins/modifier.truncate.php';
?>
